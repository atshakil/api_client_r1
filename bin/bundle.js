...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Students = __webpack_require__(222);

	var _Students2 = _interopRequireDefault(_Students);

	var _StudentInfo = __webpack_require__(224);

	var _StudentInfo2 = _interopRequireDefault(_StudentInfo);

	var _StudentEdit = __webpack_require__(225);

	var _StudentEdit2 = _interopRequireDefault(_StudentEdit);

	var _StudentCreate = __webpack_require__(226);

	var _StudentCreate2 = _interopRequireDefault(_StudentCreate);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var base_url = "http://0.0.0.0:9000/"; //var json_data = [{"id":1,"name":"Student 1","gpa":5.0,"level":6,"address":"Dhaka","created_at":"2016-08-23T15:47:34.673Z","updated_at":"2016-08-23T15:47:34.673Z"},{"id":2,"name":"Student 2","gpa":5.0,"level":6,"address":"Dhaka","created_at":"2016-08-23T15:48:16.509Z","updated_at":"2016-08-23T15:48:16.509Z"},{"id":3,"name":"Student 3","gpa":5.0,"level":6,"address":"Dhaka","created_at":"2016-08-23T15:48:23.469Z","updated_at":"2016-08-23T15:48:23.469Z"},{"id":4,"name":"Student 4","gpa":5.0,"level":6,"address":"Dhaka","created_at":"2016-08-23T15:48:27.484Z","updated_at":"2016-08-23T15:48:27.484Z"},{"id":5,"name":"Student 5","gpa":4.0,"level":6,"address":"Dhaka","created_at":"2016-08-23T15:48:37.621Z","updated_at":"2016-08-23T15:48:37.621Z"}]
	...
	var Helper = {
	  switchPageTo: function switchPageTo(page) {
	    alert(page);
	  }
	};
	...
	var App = _react2.default.createClass({
	  ...
	  handleStudentLink: function handleStudentLink(id) {
	    var student = $.grep(this.state.students, function (student) {
	      return student.id == id;
	    })[0];
	    this.setState({ student: student });
	    this.switchPageTo(pages.STUDENT_INFO);
	  },
	  handleEditLink: function handleEditLink(id) {
	    this.switchPageTo(pages.STUDENT_EDIT);
	  },
	  handleDeleteLink: function handleDeleteLink(id) {
	    this.setState({ students: this.fetchStudents() });
	    this.switchPageTo(pages.STUDENTS);
	  },
	  handleSaveLink: function handleSaveLink(id) {
	    this.setState({ students: this.fetchStudents() });
	    this.switchPageTo(pages.STUDENTS);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Student = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	  ...
	  handleInputName: function handleInputName(event) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "form",
	        { onSubmit: this.handleSubmit, className: "edit-form" },
	        _react2.default.createElement(
	          "table",
	          { className: "table tbl-noborder" },
	          _react2.default.createElement(
	            "tbody",
	            null,
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { name: "student[name]", onChange: this.handleInputName, value: this.state.student.name })
	              )
	            )
	          )
	        ),
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        "form",
	        { onSubmit: this.handleSubmit, className: "create-form" },
	        _react2.default.createElement(
	          "table",
	          { className: "table tbl-noborder" },
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                "td",
	                null,
	                _react2.default.createElement("input", { name: "student[name]" })
	              )
	            )
	          )
	        ),
